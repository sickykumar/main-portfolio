...
// Custom GitHub SVG component matching Lucide's icon style
...
// Custom LinkedIn SVG component matching Lucide's icon style
...
// Custom Facebook SVG component matching Lucide's icon style
export const Facebook = ({ size = 24, className = '', ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
